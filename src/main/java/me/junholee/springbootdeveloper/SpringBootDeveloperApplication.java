...
import me.junholee.springbootdeveloper.dto.TestRequest;
...
public class SpringBootDeveloperApplication {
    ...
    public ApplicationRunner initializeData(StandingsRequest standingsRequest, TeamRequest teamRequest, MatchRequest matchRequest, TestRequest testRequest) {
        return args -> {
